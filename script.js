...
const Zarins = document.querySelector(".Zarins");
const Krists = document.querySelector(".Krists");
const Davis = document.querySelector(".Davis");

const players = [Lagzdins, Zarins, Krists, Davis];
